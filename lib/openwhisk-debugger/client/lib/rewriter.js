...
exports.invoke = (ow, eventBus) => (action, params) => {
	...
	.then(since => ow.actions.invoke({ name: invokeThisAction, params: params })
	      .then(() => waitForActivationCompletion(ow, eventBus, waitForThisAction, { result: true, since: since })))
}
